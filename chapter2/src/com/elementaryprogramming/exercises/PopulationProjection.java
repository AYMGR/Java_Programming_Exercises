...
public class PopulationProjection {
  ...
  public static void main(String[] args) {
    ...
    double totalPopulationInYears = years * tumberOfPeopleIncreasedEachYear +numOfCurrentPopulation;

    // step4: Display the final population
    System.out.println("The population in " + years + " years is " + (long)totalPopulationInYears);
