...
public class PopulationProjection {
    ...
    public static void main(String[] args) {
        ...
        long AnnualBirths = (long) secondsOfTheYear / 7;
        long AnnualDeaths = (long) secondsOfTheYear / 13;
        long AnnualImmigrant = (long) secondsOfTheYear / 45;
        long annualGrowth = (AnnualBirths + AnnualImmigrant) - AnnualDeaths;
        ...
        System.out.println("Population for the next second year is：" + (numOfCurrentPopulation + annualGrowth * 2));
        System.out.println("Population for the next third year is：" + (numOfCurrentPopulation + annualGrowth * 3));
        System.out.println("Population for the next fourth year is：" + (numOfCurrentPopulation + annualGrowth * 4));
        System.out.println("Population for the next fifth year is：" + (numOfCurrentPopulation + annualGrowth * 5));
